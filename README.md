...
Evidence-driven disassembly research for **Pocket Monsters Gin / Pokémon Silver**.
...
| Scope | Japanese and localized Silver releases with version relationships derived from evidence. |
